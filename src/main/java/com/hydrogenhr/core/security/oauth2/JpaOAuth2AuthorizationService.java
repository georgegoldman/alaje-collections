package com.hydrogenhr.core.security.oauth2;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.Module;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.hydrogenhr.persistence.entity.Authorization;
import com.hydrogenhr.persistence.repository.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    private OAuth2Authorization toObject(Authorization entity) {
        ...
        if (registeredClient == null) {
            throw new DataRetrievalFailureException("The RegisteredClient with id " + entity.getId() + " was not found in the RegisteredClientRepository.");
        }
